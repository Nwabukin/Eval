/**
 * Shared DTO shapes for type-safe API consumption on the frontend.
 * These mirror the backend DTOs but without class-validator decorators.
 */

import type { UserRole, CalibrationMode } from "./enums.js";
